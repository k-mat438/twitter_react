...
export default function ScrollDialogButton(props) {
  const { variant, sx, buttonText, formComponent: FormComponent, setOpenAlert, setFalseRegister, setIsSignedIn, setUser } = props;
        ...
        <DialogContent sx={{ padding: '0 80px' }}>
          ...
          {loading ? 
            <Box sx={{display:'flex',justifyContent:'center'}}>
             ...
             : <FormComponent handleClose={handleClose} setOpenAlert={setOpenAlert} setFalseRegister={setFalseRegister} setIsSignedIn={setIsSignedIn} setUser={setUser}/>}
          <DialogContentText
